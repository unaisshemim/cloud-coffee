/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.events.jsonc src/worker-configuration.d.ts` (hash: f061e48c7664fedeb9f1874f85bf32d1)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	RESUME_UPDATES: DurableObjectNamespace<import("../test/cloudflare/worker").ResumeUpdateRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../test/cloudflare/worker");
		durableNamespaces: "ResumeUpdateRoom";
	}
