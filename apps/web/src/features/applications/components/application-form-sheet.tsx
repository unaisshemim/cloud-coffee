		...
		<Sheet open={open} onOpenChange={onOpenChange}>
			<SheetContent side="right" className="w-full gap-0 data-[side=right]:sm:max-w-lg">
				...
				<div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto px-4 pb-4 [&>*]:shrink-0">
					...
					{/* Resume: link a live cloudcoffee (unlocks AI) or upload the exact PDF you sent. */}
					<Field label={t`Resume`}>
						<div className="flex flex-col gap-2">
							<Combobox
								...
								placeholder={t`Link a cloudcoffee (recommended)`}
								showClear
							...
							/>
							<p className="text-[11px] text-muted-foreground">
								<Trans>Linking a cloudcoffee enables AI match scoring and tailoring.</Trans>
							</p>
						</div>
					</Field>
