...
type ResumePreviewLoaderProps = Pick<ResumePreviewProps, "pageClassName" | "showPageNumbers" | "visiblePage"> & {
	pageCount?: number;
	pageGap?: CSSProperties["gap"];
	pageLayout?: "horizontal" | "vertical";
	pageScale?: number;
...
export function ResumePreviewLoader({
	...
	const pageNumbers = visiblePage
		? [Math.min(Math.max(visiblePage, 1), pageCount)]
