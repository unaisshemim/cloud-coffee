...
import { createResumeDashboardTools } from "@/features/webmcp/resume-dashboard-tools";
	...
	const webMcpTools = useMemo(
		() => [
			createPageDescriptionTool({
				...
				search: { search, tags, sort, view },
				capabilities: ["rr.resumes.list_visible", "rr.resumes.open", "rr.resumes.start_create", "existing-mcp-parity"],
			}),
			...createResumeDashboardTools({ resumes: filteredResumes, navigate, openDialog }),
			...createWebMcpParityTools(),
		],
		[filteredResumes, navigate, openDialog, search, sort, tags, view],
	);
