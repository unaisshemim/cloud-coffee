---
title: "cloudcoffee changelog"
description: "Release notes for cloudcoffee covering new features, resume builder updates, PDF export fixes, AI changes, and self-hosting news."
rss: true
---
...
- Added 17 comparison pages covering cloudcoffee against mainstream resume builders, AI and ATS tools, design editors, and career and template services. [9d6426b2e](https://github.com/amruthpillai/reactive-resume/commit/9d6426b2e)
...
- Published cloudcoffee MCP registry metadata so MCP clients and directories can discover the hosted remote server. [73daf22b2](https://github.com/amruthpillai/reactive-resume/commit/73daf22b2)
...
- **New application MCP guide.** The docs now include a dedicated guide with practical prompts for using cloudcoffee MCP to manage applications from an AI client.
...
- Updated the resume-builder skill instructions so agents are told that cloudcoffee MCP can also manage job applications, not only resumes. [ac8734be3](https://github.com/amruthpillai/reactive-resume/commit/ac8734be3)
...
- Added design-sync inputs and preview files for cloudcoffee UI components. [a28e3baa](https://github.com/amruthpillai/reactive-resume/commit/a28e3baa), [6e7fc680](https://github.com/amruthpillai/reactive-resume/commit/6e7fc680)
...
- **File-first import with auto-detection.** Pick a file and cloudcoffee detects the format; AI-based imports check for a configured provider up front. [e586a78e](https://github.com/amruthpillai/reactive-resume/commit/e586a78e)
...
- Added a development Dockerfile plus improved Compose development services and health checks for running cloudcoffee with local dependencies. [1294d3354](https://github.com/amruthpillai/reactive-resume/commit/1294d3354)
...
- Added a cloudcoffee design system reference and updated dependencies across the workspace. [#3062](https://github.com/amruthpillai/reactive-resume/pull/3062)
...
- **One-service deployment.** Self-hosted Compose files no longer need a `printer:` service block. The minimum stack is now just cloudcoffee + PostgreSQL (with optional S3-compatible storage and SMTP).
...
## Fixes & Security
- Thank you to [@shaxbozaka](https://github.com/shaxbozaka) for running a security audit on cloudcoffee and helping make the app more secure.
...
This release is a major overhaul of cloudcoffee. The app has been completely redesigned and rebuilt from scratch for a more intuitive, user-friendly experience.
