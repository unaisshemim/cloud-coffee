...
description: "Set up a local development environment for cloudcoffee with pnpm, Docker services, environment variables, and the web and server apps."
---
...
This guide walks you through setting up cloudcoffee for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local cloudcoffee instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
cloudcoffee uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to cloudcoffee</Trans>;
```
