---
title: "Introduction to cloudcoffee"
description: "cloudcoffee is a free, open-source resume builder that lets you create, update, export, and share professional resumes without accounts or paywalls."
---

<Frame>
  <img src="/images/getting-started/banner.webp" alt="cloudcoffee Banner" />
</Frame>

## What is cloudcoffee?

**cloudcoffee** is a free and open-source resume builder designed to simplify the process of creating, updating, and sharing your professional resume. Built with privacy as a core principle, it gives you complete control over your data while providing a powerful, modern experience.
...
<Frame>
  <img src="/images/getting-started/infographic.webp" alt="An infographic of the major features of cloudcoffee" />
</Frame>

<AccordionGroup>
	<Accordion title="Completely Free & Open Source" icon="code-branch">
		cloudcoffee is licensed under MIT. You can use it for free, modify it, and even host your own instance. The
		entire codebase is available on [GitHub](https://github.com/amruthpillai/reactive-resume).
	</Accordion>

    <Accordion title="Treecko Template" icon="grid-2">
		Build with Treecko, a clean single-column design with customizable typography, colors, spacing, and page margins.
    </Accordion>
    ...
    <Accordion title="Multi-language Support" icon="globe">
		cloudcoffee supports multiple languages, making it accessible to users worldwide. Contribute translations to
    ...
    <Accordion title="Self-hosting Ready" icon="server">
		Deploy your own instance of cloudcoffee using Docker. Keep complete control over your data and infrastructure.
    </Accordion>
...
Whether you want to use our hosted version or run your own instance, cloudcoffee has got you covered.
...
<CardGroup cols={2}>
  ...
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a local development environment to contribute or customize cloudcoffee.
  </Card>
</CardGroup>

## Tech Stack

cloudcoffee is built with modern web technologies:
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub Discussions" icon="comments" href="https://github.com/amruthpillai/reactive-resume/discussions/categories/q-a">
    Ask questions about setup, configuration, and using cloudcoffee.
  </Card>
  ...
  <Card title="Sponsor" icon="heart" href="https://opencollective.com/reactive-resume/donate">
    Support the development and long-term sustainability of cloudcoffee.
  </Card>
</CardGroup>
