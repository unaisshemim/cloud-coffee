---
title: "Quickstart"
description: "Get started with cloudcoffee in minutes by signing in to the hosted version or deploying your own self-hosted instance with Docker Compose."
---

## Options

cloudcoffee offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use cloudcoffee is through our cloud version at [rxresu.me](https://rxresu.me). **This service is completely free and will always remain free.**
...
For users who prefer complete control over their data, you can deploy cloudcoffee on your own infrastructure using Docker.
...
# AI features (optional; required for saved providers)
...
```
    ...
    <Step title="Start the Services">
		...
		- **cloudcoffee** — The main application
    </Step>

    <Step title="Access Your Instance">
		Once all services are running, access your cloudcoffee instance at:
...
| `reactive_resume` | 3000 | The main cloudcoffee application                 |

<Note>
  Saved AI provider management requires `ENCRYPTION_SECRET`. Other cloudcoffee features can run without it.
</Note>
...
> **AI features:** Saved AI provider management requires `ENCRYPTION_SECRET`. Keep `FLAG_ALLOW_UNSAFE_AI_BASE_URL` disabled unless this is a trusted self-hosted deployment; public HTTPS provider URLs are the safe default.
...
<CardGroup cols={2}>
  <Card title="Development Setup" icon="code" href="/contributing/development">
    Set up a development environment to contribute or customize cloudcoffee.
  </Card>
