...
description: "Learn how to access the previous version (v4) of cloudcoffee if you need to retrieve old resumes or prefer the classic experience."
---

## The previous version is still available

If you've been using cloudcoffee for a while, you may have resumes saved in the previous version of the application. The good news is that **version 4 (v4) is still fully accessible** and will remain online for the foreseeable future.

<Info>The previous version of cloudcoffee is available at [https://v4.rxresu.me](https://v4.rxresu.me).</Info>
...
If you'd like to move your resumes to the latest version of cloudcoffee, you can export them from v4 and import them into the new version:
