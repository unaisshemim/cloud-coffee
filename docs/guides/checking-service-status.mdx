...
description: "Check the current uptime and incident status for cloudcoffee's hosted servers and learn what to do when the service is experiencing issues."
---

## Status Page

You can monitor the health and availability of cloudcoffee's servers at any time by visiting our status page:
...
<Steps>
  ...
  <Step title="Wait and try again later">
    ...
    <Info>
      cloudcoffee is a **free, open-source service** used by thousands of people worldwide. During peak times, the servers may experience higher than usual load.
    </Info>
...
<Warning>
  cloudcoffee is a **free service** that runs on limited server resources. As an open-source project maintained by a
...
If you find cloudcoffee valuable and want to help keep the servers running smoothly (and maybe even help scale them up), please consider supporting the project.

---

## Support the Project

Your donations directly help cover server costs, improve infrastructure, and keep cloudcoffee free for everyone.

<Card title="Donate on Open Collective" icon="heart" href="https://opencollective.com/reactive-resume/donate">
  Support cloudcoffee's development and server costs through Open Collective. Every contribution helps keep the
  service running.
</Card>
...
If you need guaranteed uptime or want to avoid shared server limitations, you can always self-host cloudcoffee on your own infrastructure.

<Card title="Self-Hosting Guide" icon="server" href="/self-hosting/docker">
  Learn how to deploy cloudcoffee on your own servers using Docker.
</Card>
