...
description: "Sign up for a cloudcoffee account with email and password or social sign-in from Google or GitHub so you can start building and saving resumes."
---
...
<Steps>
  ...
  <Step title="Sign up and log in">
    After filling in all the required fields, click the **Sign Up** button. You will be immediately logged in and can start using cloudcoffee right away.
