...
description: "Export your cloudcoffee as a portable Markdown file for AI tools, personal websites, notes, version control, or quick plain-text edits."
---
...
<Tip>
  If you are sharing the file with an AI assistant, include the job description in the same prompt and ask for changes as Markdown. That makes the result easy to compare before you update the resume in cloudcoffee.
</Tip>
