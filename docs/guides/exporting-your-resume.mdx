...
description: "Download your resume or cover letter from cloudcoffee as PDF, DOCX, Markdown, or JSON, and pick the right format for each situation."
---

cloudcoffee can export your resume, and your cover letter separately when you have one, in four formats.
...
| **JSON** | Backups, restoring a resume later, or importing into another cloudcoffee account. |
...
- sharing a finished copy outside cloudcoffee.
