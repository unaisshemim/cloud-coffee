...
description: "Move existing job applications into the cloudcoffee Application Tracker by uploading a CSV file or pasting spreadsheet rows with headers."
---

Use CSV import when you already track applications in a spreadsheet and want to move them into cloudcoffee.
...
<Steps>
  ...
  <Step title="Review the preview">
    cloudcoffee shows how many rows are ready to import, which columns it recognized, and how many rows were skipped.
  </Step>
...
cloudcoffee imports up to 500 applications at a time. If your CSV has more than 500 valid rows, split it into smaller files and import each file separately.
...
<Tip>
  API clients can also import application rows programmatically through the authenticated application endpoints.
</Tip>
