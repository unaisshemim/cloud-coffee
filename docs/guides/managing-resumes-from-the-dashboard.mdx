...
description: "Search, sort, filter, open, duplicate, lock, update, and delete resumes from the cloudcoffee Resumes dashboard in grid or list view."
---
...
You can also open the command palette from anywhere in the app with `Cmd/Ctrl+K`, or by clicking **Search** in the dashboard sidebar. From there you can jump to a resume or application by name, or run quick actions like **New Application**. Select **Resumes** or **Applications** to filter results to a single entity type.
...
<Info>
  After you create or import a resume, cloudcoffee opens it directly in the builder instead of returning you to the
  dashboard.
</Info>
