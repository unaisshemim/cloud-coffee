...
description: "Move resume items between sections or across pages in the cloudcoffee builder to reorganize content and split lengthy sections cleanly."
---
...
<Step title="Hover over 'Move to'">
  ...
  <Step title="Select a destination">
    ...
    <Tip>
      If a custom section of the same type doesn't exist on your target page, cloudcoffee will **automatically create one** for you. This makes it easy to split sections across pages without manual setup.
    </Tip>
