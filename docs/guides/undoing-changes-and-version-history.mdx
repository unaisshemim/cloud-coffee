...
description: "Undo and redo edits with keyboard shortcuts in the cloudcoffee builder, and restore an earlier snapshot from the version history menu."
---

cloudcoffee keeps two layers of change history for every resume:
...
cloudcoffee automatically snapshots your resume at key moments:
...
<Steps>
  ...
  <Step title="Pick a snapshot">
    Select the entry you want to restore. cloudcoffee asks you to confirm before replacing the current data.
  </Step>
