...
description: "Ready-to-use Docker Compose examples for self-hosting cloudcoffee with Postgres, Traefik, Caddy, Nginx Proxy Manager, and other common deployment stacks."
---
...
This example uses [Traefik](https://traefik.io/) as a reverse proxy with automatic SSL certificate management via Let's Encrypt. Only the cloudcoffee app is exposed through Traefik—Postgres remains on an internal network.
