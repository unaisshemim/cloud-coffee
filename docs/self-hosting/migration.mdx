...
description: "Step-by-step guide to migrate a self-hosted cloudcoffee instance from v4 to v5, covering database schema changes, manual and automated options."
---

## Overview

This guide walks you through migrating your cloudcoffee installation from **v4 to v5**. The migration process involves setting up a new v5 instance alongside your existing v4 instance, then transferring your users and resumes to the new system.
...
<CardGroup cols={2}>
  ...
  <Card title="New v5 Instance">
    A fresh cloudcoffee v5 instance set up and running. Follow the [Self-Hosting with Docker](/self-hosting/docker)
...
<CardGroup cols={1}>
  ...
  <Card title="cloudcoffee Source Code">
    Clone the cloudcoffee repository and check out the last tag that includes the migration scripts:
    ```bash
