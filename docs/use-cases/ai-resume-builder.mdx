...
AI features can help with AI-assisted changes in the builder, an optional review of your writing in the ATS checker, AI agent drafts, and supported import workflows. The core resume builder — and the ATS checker itself — still works without AI.
