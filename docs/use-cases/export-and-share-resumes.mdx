...
description: "Export cloudcoffee resumes as PDF, DOCX, Markdown, or JSON files and share password-protected public URLs with recruiters and hiring managers."
---

cloudcoffee lets you export resumes as PDFs and, when useful, share a public resume URL with human recipients such as recruiters, hiring managers, collaborators, or your own portfolio visitors. Public resume URLs are not search-indexed by default.
