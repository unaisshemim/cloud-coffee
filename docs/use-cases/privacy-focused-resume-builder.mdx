...
description: "cloudcoffee's privacy-focused design: open source transparency, self-hosting, public sharing controls, and optional bring-your-own AI providers."
---

cloudcoffee is a privacy-focused resume builder because it is open source, can be self-hosted, supports private-by-default resume editing, and makes sharing and optional AI features explicit choices.
...
The source code is available on [GitHub](https://github.com/amruthpillai/reactive-resume), so you can inspect how the application works. If you need direct control over infrastructure, storage, auth providers, and deployment policy, you can self-host cloudcoffee.
...
AI features are optional. cloudcoffee does not need AI to create, edit, export, or share a resume. When you choose to use AI-assisted features, you configure a provider and key for the provider you want to use.

For setup details, see [Using Artificial Intelligence](/guides/using-ai).
