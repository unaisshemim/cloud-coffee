...
Some features require extra configuration. For example, saved AI providers need server-side encryption configuration. Self-hosted deployments can also expose API and MCP endpoints from their own domain.
