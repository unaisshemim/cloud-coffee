...
export const flagsRouter = {
	get: publicProcedure
		.route({
			...
			description:
				"Returns the current feature flags for this cloudcoffee instance. Feature flags control instance-wide settings such as whether new user signups are disabled. No authentication required.",
