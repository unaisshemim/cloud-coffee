				...
				<Body className="m-0 bg-zinc-950 p-0 font-body text-sm text-zinc-50">
					...
					<Container className="mx-auto w-full max-w-xl bg-zinc-900 p-6 text-zinc-50">
						...
						<Section className="mt-6">
							...
							<Text className="mt-8 font-heading font-medium text-base tracking-tight opacity-80">cloudcoffee</Text>
						</Section>
					</Container>
				</Body>
			</Tailwind>
...
export function ResetPasswordEmail({ url }: ResetPasswordEmailProps) {
	return (
		<AuthEmailLayout
			...
			actionUrl={url}
			outro="For security, only use links from emails sent by cloudcoffee."
		/>
	);
}
